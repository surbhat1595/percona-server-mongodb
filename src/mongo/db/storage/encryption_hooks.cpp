...
StatusWith<std::deque<StorageEngine::BackupBlock>> EncryptionHooks::beginNonBlockingBackup(
...
StatusWith<std::deque<std::string>> EncryptionHooks::extendBackupCursor() {
