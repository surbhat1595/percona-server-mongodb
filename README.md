...
Use [Installing Percona Server for MongoDB](https://docs.percona.com/percona-server-for-mongodb/7.0/install/index.html) to navigate to the required installation instructions.
